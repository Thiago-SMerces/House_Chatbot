...
def tree_to_code(tree, subarvores):
    ...
    with open("generated_tree.py", 'w', encoding='utf8') as f:
    ...
    file_object = open('generated_tree.py', 'a',encoding='utf8')
    ...
    def recurse(node, depth):
        ...
        # Quando for um nó folha, definir a classe a que pertence
            ...
            if attribute_tree.value[node][0][0] > total*0.6:
                classe = '"Classificação final da casa: Barata"'
            # Entre 40% e 60% de "sim", atribuir como média
                ...
                classe = '"Classificação final da casa: Media"'
            # Menos de 40% de "sim", atribuir como cara
            else:
                classe = '"Classificação final da casa: Cara"'
