...
def tree_to_code(tree, subarvores):
    ...
    with open("generated_tree_gui.py", 'w', encoding='utf8') as f:
        ...
        f.write("{}def decision(self, root, inte):\n".format(space))

        # objeto para guardar a classificação da casa
        f.write("{}{}classe = None\n".format(space, space))

        # para evitar mensagens de erro na finalização do programa
        f.write("{}{}try:\n".format(space, space))

    # Manter o arquivo generated_tree.py aberto enquanto adicionamos novas linhas a ele
    file_object = open('generated_tree_gui.py', 'a', encoding='utf8')
    ...
    def recurse(node, depth):
        ...
        if attribute_tree.feature[node] != _tree.TREE_UNDEFINED:
            ...
            if name not in parameters.keys():
                ...
                file_object.write("{}{}{}{} = inte.show(root, classe, '{}')\n".format(space, space, indent, name, name))

            # Escrever estrutura de decisão conforme os nós aparecem
            file_object.write("{}{}{}if {} <= {}:\n".format(space, space, indent, name, threshold))
        ...
        # Quando for um nó folha, definir a classe a que pertence
            ...
            file_object.write("{}{}{}inte.format_response({})\n".format(space, space, indent, classe))
            file_object.write("{}{}{}return inte.show(root, classe, None)\n".format(space, space, indent))

    # Primeira chamada da função recursiva, devemos passar o nó inicial (raiz) = 0 e a profundidade dele = 1
    recurse(0, 1)

    # Encerrar bloco try/except
    file_object.write("{}{}except:\n".format(space, space))
    file_object.write("{}{}{}print('Janela Fechada! Encerrando aplicação...')\n".format(space, space, space))
